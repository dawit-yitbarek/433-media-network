...
const FeaturedFilms = () => {
    ...
    return (
        <section className="relative py-24 px-4 md:px-12 bg-gradient-to-b from-[#0A0F1C] to-[#141A29] text-[#EAEAEA] overflow-hidden">
            {/* Glow background */}
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 right-6 z-10">
                            ...
                            <div className="flex justify-between items-center mt-3">
                                ...
                                <button className="flex items-center gap-2 text-[#00E0FF] hover:underline text-sm font-medium">
